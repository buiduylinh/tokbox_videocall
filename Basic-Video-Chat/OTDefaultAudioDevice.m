...
- (void) handleRouteChangeEvent:(NSNotification *) notification
{
    ...
    if (newRoute && newRoute.outputs.count > 0) {
        ...
        NSLog(@"Current audio route is 1 [%s]", [route UTF8String]);
        
//        if (_hasVideo) {
//            if ([route  isEqual: @"Receiver"]) {
//                [self configureAudioSessionWithDesiredAudioRoute: AUDIO_DEVICE_SPEAKER];
//            }
//            if ([route  isEqual: @"Headphones"]) {
//                [self configureAudioSessionWithDesiredAudioRoute: AUDIO_DEVICE_HEADSET];
//            }
//            if ([route  isEqual: @"Speaker"]) {
//                [self configureAudioSessionWithDesiredAudioRoute: AUDIO_DEVICE_SPEAKER];
//            }
//        }
//        if (!_hasVideo) {
