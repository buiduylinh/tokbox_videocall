...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customVideoCapturer = new CustomVideoCapturer(this, Publisher.CameraCaptureResolution.MEDIUM, Publisher.CameraCaptureFrameRate.FPS_30);

        SeekBar seekBarBeauty = findViewById(R.id.seekBarBeauty);
        seekBarBeauty.setMax(100);
        SeekBar seekBarTone = findViewById(R.id.seekBarTone);
        seekBarTone.setMax(100);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            case R.id.seekBarBeauty:
                customVideoCapturer.setBeautyLevel((float) progress);
                break;
            case R.id.seekBarTone:
                customVideoCapturer.setToneLevel((float) progress);
                break;
        }
    }
    ...
    public void onConnected(Session session) {
        ...
        mPublisher = new Publisher.Builder(this).capturer(customVideoCapturer).build();
